...
@RecordBuilder
public record ServerWallet(UUID walletId, List<HsmKey> hsmKeys, List<DeviceKey> deviceKeys, Optional<Instant> revoked, Instant created, Instant updated, int version) {
